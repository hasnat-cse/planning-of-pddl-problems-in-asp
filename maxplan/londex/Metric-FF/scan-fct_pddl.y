...
%type <pdis_ConNode> pref_con_GD
%type <pdis_ConNode> pref_con_GD_star  
/*--PDDL3*/
...
pref_con_GD:
OPEN_PAREN dis_AND_TOK pref_con_GD_star CLOSE_PAREN
{
...
CLOSE_PAREN pref_con_GD  CLOSE_PAREN
{ 
...
|
OPEN_PAREN PREFERENCE_TOK NAME con_GD CLOSE_PAREN
{
        dis_PrefNode *pref;
        char temp[128];
...
|
OPEN_PAREN PREFERENCE_TOK con_GD CLOSE_PAREN
{
        dis_PrefNode *pref;
        char temp[128];
...
CLOSE_PAREN con_GD1 CLOSE_PAREN
{
        dis_ConNode *pln;
        pln = new_dis_ConNode(dis_ALL_c_c);
        pln->parse_vars = $4;
...
con_GD1:
OPEN_PAREN AT_END_TOK adl_goal_description CLOSE_PAREN
{
