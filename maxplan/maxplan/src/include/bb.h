...
/* by X. Z.*/
#define MAX_MUX_BUF 2000
#define MAX_FACT_IN_MUX 256
#define INFINITY_DISTANCE 65535
//#define INFINITE_DISTANCE 65535
#define CG_NO_DISTANCE -1
#define MAX_SOLUTION_ACTION 250
#define NUM_BLOCK 50
/* end of by X.Z*/
...
struct _command_line {
  ...
  char cg_domain_file_name[MAX_LENGTH];
  char cg_problem_file_name[MAX_LENGTH];
  ...
  int printEncoding;
  char printEncodingFile[MAX_LENGTH];
  
  int londex_mode;
  int londex_validation;
  int londexm;
  int printLondex;
  int startLevel;
};
...
typedef struct _OpConn {
  ...
  BitVector *bit_Mux; /* MaxPlan by X.Z. */
...
extern float encoding_time,solving_time;
...
/* Below, by R.H*/
long solver_start_clk;
float max_memory_usage;


extern const int LONDEX_MODE_NONE;
extern const int LONDEX_MODE_STATIC;
extern const int LONDEX_MODE_ONDEMAND;


extern int mutex_count;
extern int londex_count;
extern int long_in_mutex_count;
